...
{
    public class VideoPlayerRockVR : MonoBehaviour
    {
        ...
        private int index = 0;
        public static VideoPlayerRockVR instance;
        private void Awake()
        {
            if (instance == null)
            {
        ...
        public void SetRootFolder()
        {
            ...
            // Init VideoPlayerRockVR properties.
        ...
        public void PlayVideo()
        {
            ...
            Debug.Log("[VideoPlayerRockVR::PlayVideo] Video Path:" + videoFiles[index]);
        ...
        public void NextVideo()
        {
            ...
            {
                Debug.LogWarning("[VideoPlayerRockVR::NextVideo] All videos have already been played.");
            }
        }
#endif
    }
